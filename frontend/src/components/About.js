...
function About() {
  return (
    <>
      <div className='min-h-[400px] gri ml-6 mr-6'>
        <div>
          <h1 className="flex mt-[150px] justify-center
           text-[10rem]  text-[#91FFFF]">01</h1>
      ...
      <div className='min-h-[400px] gri ml-6'>
        ...
        <div>
          <h1 className="flex justify-center
           text-[10rem]  text-[#91FFFF]">02</h1>
           
        </div>
      </div>
      <div className='min-h-[600px] gri ml-6'>
      <div>
          <h1 className="flex justify-center
           text-[10rem]  text-[#91FFFF]">03</h1>
